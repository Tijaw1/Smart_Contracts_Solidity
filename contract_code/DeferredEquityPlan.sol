...
contract DeferredEquityPlan {
    ...
    // number of shares vested per year
    ...
    // variable for forwarding the time for testing purposes only
    ...
    function distribute() public {
        ...
        require(unlock_time <= fakenow,"You need atleast a year for shares to be vested!");
       
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares,"You have already cashed out all shares!");
